...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-d79iok)op%p6xbs298nm43uy5^e8wmf0free6-@okh&09l4p81')
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # ✅ Optional, if you use custom template dir
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# ✅ Add this to serve static files in production (Render)
